JsUnitTest.Unit.CLILogger = function(element) {
...
JsUnitTest.Unit.CLILogger.prototype.getLastLogLine = function() {
  //var tbody = this.element.getElementsByTagName('tbody')[0];
  //var loglines = tbody.getElementsByTagName('tr');
  //return loglines[loglines.length - 1];
};
  
JsUnitTest.Unit.CLILogger.prototype.getMessageCell = function() {
  //var logline = this.getLastLogLine();
  //return logline.getElementsByTagName('td')[2];
};
  
JsUnitTest.Unit.CLILogger.prototype._createLogTable = function() {
...
JsUnitTest.Unit.CLILogger.prototype.appendActionButtons = function(actions) {
  // actions = $H(actions);
...
JsUnitTest.Unit.CLILogger.prototype._toHTML = function(txt) {
